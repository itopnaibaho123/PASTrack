...
export default function FormCreateMataPelajaran ({handleSubmit,children}) {
              ...
              <div className="fixed inset-0 w-screen h-screen grid place-items-center">
                <div className="px-4">
                  ...
                  <div className="bg-white rounded-lg max-w-[448px] mx-auto p-6">
                    <B className="text-xl mb-2">Create Mata Pelajaran</B>
                    <p className="text-gray-500 mb-4">
                      Are You Sure Want To Create This Mata Pelajaran
                    </p>
