...
export default function Select({
  ...
  if (semester) {
    function getSemester(item) {
      ...
      var stringTanggalBuka =
        tanggalBuka.getDate() +
        "/" +
        tanggalBuka.getMonth() +
        "/" +
        tanggalBuka.getFullYear() +
        " - ";
      var stringTanggalTutup =
        tanggalTutup.getDate() +
        "/" +
        tanggalTutup.getMonth() +
        "/" +
        tanggalTutup.getFullYear();
      if (item["semester"] === false) {
        return (
          "Genap " + String(stringTanggalBuka) + String(stringTanggalTutup)
        );
      } else {
        return (
          "Ganjil " + String(stringTanggalBuka) + String(stringTanggalTutup)
        );
      }
    }
